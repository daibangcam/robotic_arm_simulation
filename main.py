...
from mpl_toolkits.mplot3d import Axes3D  # Thư viện cho đồ thị 3D
...
class H2Q_Multi_Robot_GUI_Final:
    def __init__(self, root):
        self.root = root
        self.root.title("H2Q Lab - Mô phỏng cánh tay Robot v2.1")
        ...
        self.LEFT_WIDTH = 270  # Chiều rộng cố định cho cột điều khiển

        # --- KHAI BÁO BIẾN SỐ TAB RR ---
        ...
        # --- KHAI BÁO BIẾN SỐ TAB RRR-1 (MẶT PHẲNG 2D) ---
        ...
        # --- KHAI BÁO BIẾN SỐ TAB RRR-2 (KHÔNG GIAN 3D) ---
